...
subroutine g(m,X,delta,npoints,gval)
  integer npoints
  real*8 I1, I2, I3, I4, g1(npoints), g2(npoints), g3(npoints), g4(npoints), &
    &m, X(npoints), gval, delta
...
! brownian (output) contains the original brownian increments
! used to construct the diffusion.
